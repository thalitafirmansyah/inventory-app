...
<body>
    ...
    <div class="nav-menu">
        <nav class="nav">
            ...
            <a class="nav-link {{ request()->is('admin/reports/top-stock') ? 'active' : '' }}" href="/admin/reports/top-stock">
                <i class="fas fa-trophy"></i> Top 5 Stok
            </a>
            <a class="nav-link {{ request()->is('admin/reports/low-stock') ? 'active' : '' }}" href="/admin/reports/low-stock">
